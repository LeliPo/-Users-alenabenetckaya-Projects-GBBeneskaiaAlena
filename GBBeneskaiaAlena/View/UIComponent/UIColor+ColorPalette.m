...
+ (UIColor *)buttonBackgorundFW {
    return [UIColor colorWithRed:1.0 green:122.0 / 255.0 blue:122.0 / 255.0 alpha:0.55];
}
...
+ (UIColor *)cellShadowColorFW {
    return [UIColor colorWithRed:0.0/255.0 green:100.0/255.0 blue:1.0 alpha:0.55];
}
